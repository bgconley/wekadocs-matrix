...
def system_prompt(figures: FiguresMode = "enriched") -> str:
    ...
    return (
        ...
        "block, or table, write the step's prose as the list item, then place the "
        "fenced code block or table as a TOP-LEVEL block immediately AFTER that list "
        "item -- never indented inside it. (Indented code and tables inside list items "
