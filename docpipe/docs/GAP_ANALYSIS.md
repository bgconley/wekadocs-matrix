...
**Bottom line:** sound architecture and a defensible engine choice, executed as a real working pipeline — now held back from corpus-ready mainly by populated evaluation/citation proof and a small amount of remaining polish, all addressable without changing the design.
