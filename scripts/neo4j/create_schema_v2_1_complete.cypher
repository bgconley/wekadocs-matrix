...
// - Vector dimensions: 1024-D (Jina v4)
...
// CRITICAL SPECIFICATION: 1024 dimensions (Jina v4, not 384-D or 768-D)
...
// - Quality (Jina v4 @ 1024-D validated in benchmarks)
...
// - embedding_model: Model identifier (jina-embeddings-v4)
