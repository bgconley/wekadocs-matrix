// This is the query generated by src/query/traversal.py after our fix
// Testing with section that has 0 relationships
...
RETURN target.id AS id,
       ...
       {k IN keys(target) WHERE k <> 'text' | k: target[k]} AS props,
       dist,
       sample_paths
